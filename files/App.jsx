...
import { STORE_KEY, ONBOARD_KEY, WORKER_URL, APP_VERSION, APP_NAME, BUCKETS, DEFAULT_CATEGORIES } from "./constants.js";
      ...
      <div className="cg-wrap">
        ...
        <div className={`cg-hero ${left < 0 && !oculto ? "over" : ""}`}>
          ...
          <div className="cg-eyebrow">
            {oculto
              ? "Disponible"
              : (ciclo ? ciclo.left : left) >= 0
                ? "Disponible"
                : (ciclo ? ciclo.negativoPorAjuste : negativoPorAjuste)
                  ? "Ajustado a la baja"
                  : "Te has pasado"}
            {ciclo && !oculto && (
          ...
          <>
            <div className="cg-card">
              <div className="cg-stats">
                ...
                <div className="cg-stat" style={{ background: (ciclo ? ciclo.left : left) < 0 ? "#F7E9E6" : "#EAF0E8" }}>
              ...
              {(() => {
                const gastoRef = ciclo ? ciclo.spent : spent;
                ...
                if (!isCurrentMonth || gastoRef <= 0) return null;
                const media = gastoRef / diasTranscurridos;
                return (
                  <p style={{ fontSize: 12.5, color: "var(--muted)", marginTop: 12, marginBottom: 0 }}>
                    Media de {eur(media)} € al día. A este ritmo {ciclo ? "cerrarás el ciclo" : "cerrarás el mes"} en{" "}
                    <b style={{ fontFamily: "var(--mono)" }}>{eur(media * diasTotales)} €</b>.
                  </p>
                );
              })()}
            </div>
        ...
        {tab === "ajustes" && (
          <>
            ...
            <div className="cg-card">
              <h2 className="cg-title">Ciclo de nómina</h2>
              <p className="cg-hint" style={{ marginBottom: 10 }}>
                ¿Te gustaría que el dinero que se muestra en Disponible sea desde el día que recibes
              ...
              <p className="cg-hint" style={{ marginTop: 10, marginBottom: 0 }}>
                Solo cambia el número de Disponible. Los Fijos y la Previsión siguen contando siempre
